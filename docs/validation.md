...
The approved destination is [newbpydev/skills-charmbracelet](https://github.com/newbpydev/skills-charmbracelet). Public-source installation, hosted CI, skills.sh indexing/search, and release publication are pending until their observed results are recorded here. None of these local checks emits installation telemetry or writes to real global skill directories.
